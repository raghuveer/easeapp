 ...
 */
  ...
  $_SERVER['HTTPS'] = isset($_SERVER['HTTPS']) ? filter_var($_SERVER['HTTPS'], FILTER_SANITIZE_STRING) : '';
  $_SERVER['HTTP_HOST'] = isset($_SERVER['HTTP_HOST']) ? filter_var($_SERVER['HTTP_HOST'], FILTER_SANITIZE_STRING) : '';
  $_SERVER['REQUEST_URI'] = isset($_SERVER['REQUEST_URI']) ? filter_var($_SERVER['REQUEST_URI'], FILTER_SANITIZE_STRING) : '';
  /*$_SERVER['HTTP_ACCESS_CONTROL_REQUEST_METHOD'] = isset($_SERVER['HTTP_ACCESS_CONTROL_REQUEST_METHOD']) ? filter_var($_SERVER['HTTP_ACCESS_CONTROL_REQUEST_METHOD'], FILTER_SANITIZE_STRING) : '';
  $_SERVER['HTTP_ACCESS_CONTROL_REQUEST_HEADERS'] = isset($_SERVER['HTTP_ACCESS_CONTROL_REQUEST_HEADERS']) ? filter_var($_SERVER['HTTP_ACCESS_CONTROL_REQUEST_HEADERS'], FILTER_SANITIZE_STRING) : '';*/
