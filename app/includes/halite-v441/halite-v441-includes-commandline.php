...
//include(dirname(dirname(dirname(dirname(__FILE__)))) . "/app/includes/halite-v441/src/Contract/KeyInterface.php");
//The following is from /app/includes/halite-v441/autoload.php
//include "../app/includes/halite-v401/halite-v441-includes.php";
