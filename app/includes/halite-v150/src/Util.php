...
abstract class Util
{
    ...
    public static function safeStrlen($str)
    {
        static $exists = null;
        if ($exists === null) {
            //https://github.com/paragonie/halite/issues/39  $exists = \function_exists('mb_strlen');
    ...
    public static function safeSubstr($str, $start, $length = null)
    {
        static $exists = null;
        if ($exists === null) {
            //https://github.com/paragonie/halite/issues/39  $exists = \function_exists('mb_substr');
