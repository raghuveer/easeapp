...
abstract class Crypto implements Contract\AsymmetricKeyCryptoInterface
{
    ...
    public static function seal(
        ...
        //https://github.com/paragonie/halite/issues/39  if (!function_exists('\\Sodium\\crypto_box_seal')) {
    ...
    public static function unseal(
        ...
        //https://github.com/paragonie/halite/issues/39  if (!function_exists('\\Sodium\\crypto_box_seal_open')) {
