...
final class KeyFactory
{
    ...
    protected static function loadKeyFile(string $filePath): HiddenString
    {
        ...
        //$data = \Sodium\hex2bin($fileData); //commented by raghu on 07-12-2017 16:30
		$data = sodium_hex2bin($fileData);
        //\Sodium\memzero($fileData); //commented by raghu on 07-12-2017 16:46
