...
$bodyHtml = "This is the HTML message body <b>in bold!</b>";
 ...
 // $eml_content = $mail->GetSentMIMEMessage(); 
  $mail->AddAttachment("sample-test.eml","eml-file-content-disk.txt","quoted-printable","message/rfc822");
  $mail->AddStringAttachment($bodyhtml1,"sample-test-html-content-on-the-fly.eml","quoted-printable","message/rfc822");
  $mail->AddStringAttachment($bodytext,"sample-test-text-content-on-the-fly.eml","quoted-printable","message/rfc822");
